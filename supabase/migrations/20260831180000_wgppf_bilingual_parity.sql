...
പേര്: {{full_name}}
വിലാസം: {{address}}
വാർഡ്: {{ward}}  റവന്യൂ വില്ലേജ്: {{village}}  താലൂക്ക്: {{taluk}}  ജില്ല: {{district}}
പഞ്ചായത്ത്: {{panchayat}}
മൊബൈൽ: {{phone}}
തീയതി: __________  ഒപ്പ്: __________$mlt$;
...
Name: {{full_name}}
Address: {{address}}
Ward: {{ward}}  Revenue Village: {{village}}  Taluk: {{taluk}}  District: {{district}}
Panchayat: {{panchayat}}
Mobile: {{phone}}
Date: __________  Signature: __________$ent$;
begin
  insert into public.campaigns (
    ...
    '2026 ജൂലൈ 27-ലെ Western Ghats ESA കരട് വിജ്ഞാപനത്തിനെതിരെ പതിമൊന്ന് കത്ത്-ടെംപ്ലates. തിരഞ്ഞെടുത്ത് നിങ്ങളുടെ വിവരങ്ങൾ ചേർത്ത് കേന്ദ്ര മന്ത്രാലയത്തിലേക്ക് അയയ്ക്കാം.',
    'Eleven letter templates opposing the 27 July 2026 Western Ghats ESA draft notification. Select one, add your details, and send to the Ministry.',
    v_ml_intro,
    v_en_intro,
    'esz-mef@nic.in',
    ...
    'പശ്ചിമഘട്ട ജനസംരക്ഷണ സമിതി — ESA കരട് വിജ്ഞാപനം',
    'Western Ghat People Protection Forum — ESA Draft Notification',
    '2026 ജൂലൈ 27-ലെ Western Ghats ESA കരട് വിജ്ഞാപനത്തിനെതിരെ പതിമൊന്ന് കത്ത്-ടെംപ്ലates.',
    'Eleven letter templates for the 27 July 2026 Western Ghats ESA draft notification.',
    '{}'::text[],
    '{}'::text[]
  )
  ...
  insert into public.campaign_form_fields (campaign_id, field_key, label_en, label_ml, is_enabled, is_required, display_order) values
    ...
    (v_id, 'taluk',          'Taluk',                    'താലൂക്ക്',                      true,  false, 7),
    (v_id, 'ward',           'Ward number',              'വാർഡ് നമ്പർ',                   true,  false, 8),
    (v_id, 'pincode',        'PIN code',                 'പിൻകോഡ്',                      true,  false, 9),
    (v_id, 'email',          'Email',                    'ഇമെയിൽ',                       false, false, 10),
    (v_id, 'custom_message', 'Ward / village details',   'വാർഡ് / വില്ലേജ് വിവരങ്ങൾ',     true,  false, 11);
  ...
  (
    ...
    'Letter 1 — Malayalam translation of notification and documents',
    'കത്ത് 1 — മലയാളത്തിൽ വിജ്ഞാപനവും രേഖകളും ലഭ്യമാക്കണം',
...
ഈ നടപടികൾ പൂർത്തിയാക്കാതെ അന്തിമ വിജ്ഞാപനം പുറപ്പെടുവിക്കരുതെന്ന് ശക്തമായി ആവശ്യപ്പെടുന്നു.$c1m$
  ...
  (
    ...
    'Letter 2 — Publish clear village/ward/cadastral maps and Survey Number information',
    'കത്ത് 2 — വ്യക്തമായ മാപ്പുകളും cadastral വിവരങ്ങളും പ്രസിദ്ധീകരിക്കണം',
...
വ്യക്തമായ മാപ്പുകൾ ലഭ്യമാക്കിയ ശേഷം മാത്രമേ ബാധിതർക്ക് ഫലപ്രദമായ ആക്ഷേപം സമർപ്പിക്കാൻ കഴിയൂ. അതിനാൽ മാപ്പുകൾ പ്രസിദ്ധീകരിക്കുകയും തുടർന്ന് മതിയായ ആക്ഷേപ കാലാവധി അനുവദിക്കുകയും ചെയ്യണമെന്ന് ആവശ്യപ്പെടുന്നു.$c2m$,
    $c2e$The maps accompanying the draft do not enable an ordinary landholder to determine accurately whether his or her land, ward, settlement, agricultural area or forest area falls within the proposed ESA.
...
വ്യക്തമായ മാപ്പുകൾ ലഭ്യമാക്കിയ ശേഷം മാത്രമേ ബാധിതർക്ക് ഫലപ്രദമായ ആക്ഷേപം സമർപ്പിക്കാൻ കഴിയൂ. അതിനാൽ മാപ്പുകൾ പ്രസിദ്ധീകരിക്കുകയും തുടർന്ന് മതിയായ ആക്ഷേപ കാലാവധി അനുവദിക്കുകയും ചെയ്യണമെന്ന് ആവശ്യപ്പെടുന്നു.$c2m$
  ...
  (
    ...
    'Letter 3 — Exclude a ward with no forest or protected area from the ESA',
    'കത്ത് 3 — വനമോ സംരക്ഷിത പ്രദേശമോ ഇല്ലാത്ത വാർഡ് ESAയിൽ നിന്ന് ഒഴിവാക്കണം',
...
After ward-level field verification and review of official records confirm the absence of forest and protected area, the entire ward should be excluded from the final ESA notification. The revenue village must also be excluded from the ESA.$c3e$,
...
വാർഡ് തലത്തിൽ സ്ഥലപരിശോധനയും ഔദ്യോഗിക രേഖകളുടെ പരിശോധനയും നടത്തി വനമോ സംരക്ഷിത പ്രദേശമോ ഇല്ലെന്ന് സ്ഥിരീകരിച്ചാൽ ഈ വാർഡിനെ അന്തിമ ESA വിജ്ഞാപനത്തിൽ നിന്ന് പൂർണ്ണമായി ഒഴിവാക്കണമെന്നും റവന്യൂ വില്ലേജിനെയും ESAയിൽ നിന്ന് ഒഴിവാക്കണമെന്നും ആവശ്യപ്പെടുന്നു.$c3m$,
    $c3e$Ward No. ______ of our __________________ Revenue Village contains no forest land and no protected area such as a National Park or Wildlife Sanctuary.
...
വാർഡ് തലത്തിൽ സ്ഥലപരിശോധനയും ഔദ്യോഗിക രേഖകളുടെ പരിശോധനയും നടത്തി വനമോ സംരക്ഷിത പ്രദേശമോ ഇല്ലെന്ന് സ്ഥിരീകരിച്ചാൽ ഈ വാർഡിനെ അന്തിമ ESA വിജ്ഞാപനത്തിൽ നിന്ന് പൂർണ്ണമായി ഒഴിവാക്കണമെന്നും റവന്യൂ വില്ലേജിനെയും ESAയിൽ നിന്ന് ഒഴിവാക്കണമെന്നും ആവശ്യപ്പെടുന്നു.$c3m$
  ...
  (
    ...
    'Letter 4 — Revenue villages in Kerala should not be included wholesale in the ESA',
    'കത്ത് 4 — കേരളത്തിലെ റവന്യൂ വില്ലേജുകളെ blanket ആയി ESA ആക്കരുത്',
...
Kerala-specific conditions should be considered and a scientific micro-level demarcation should be undertaken based on forest land, protected areas and ecologically fragile areas. Densely inhabited and cultivated areas should not be included by blanket treatment in the ESA.$c4e$,
...
കേരളത്തിന്റെ പ്രത്യേക സാഹചര്യങ്ങൾ കണക്കിലെടുത്ത് വനഭൂമി, സംരക്ഷിത പ്രദേശം, യഥാർത്ഥ ecologically fragile areas എന്നിവയുടെ ശാസ്ത്രീയമായ micro-level demarcation നടത്തണം. ജനവാസവും കൃഷിയും ഉൾപ്പെടുന്ന പ്രദേശങ്ങളെ blanket inclusion-ൽ നിന്ന് ഒഴിവാക്കണം.$c4m$
  ...
  (
    ...
    'Letter 5 — Residential areas and agricultural lands should be excluded from the final ESA boundary',
    'കത്ത് 5 — ജനവാസവും കൃഷിയിടങ്ങളും ഒഴിവാക്കണം',
...
യഥാർത്ഥ പരിസ്ഥിതി പ്രാധാന്യമുള്ള പ്രദേശങ്ങളെ മാത്രം ശാസ്ത്രീയമായി തിരിച്ചറിഞ്ഞ് ESA പരിധിയിൽ ഉൾപ്പെടുത്തണമെന്ന് ആവശ്യപ്പെടുന്നു.$c5m$
  ...
  (
    ...
    'Letter 6 — Verify the 9,107 sq. km forest figure used in the draft notification',
    'കത്ത് 6 — 9,107 ച.കി.മീ. വനവിസ്തൃതിയുടെ കണക്കുകൾ പുനഃപരിശോധിക്കണം',
    'The 9,107 sq. km figure appears to be the entire Kerala forest area, not the forest in the listed villages alone.',
    '9,107 ച.കി.മീ. എന്നത് 131 വില്ലേജുകളുടെ വനമല്ല, സംസ്ഥാനത്തിന്റെ മൊത്തം വനവിസ്തൃതിയാണെന്ന് ആശങ്ക.',
    $c6e$The draft notification uses a figure of 9,107 square kilometres of forest area in relation to the proposed ESA in Kerala across 131 villages. This figure matches the Forest Department's official record for the entire forest area of the State, not the forest area of the listed villages alone, which is substantially smaller.

Forest Department official records, revenue records, and the actual geographical extent of the ESA villages should be cross-verified.

Any numerical error or boundary discrepancy should be corrected before the final notification is issued.$c6e$,
    $c6m$കരട് വിജ്ഞാപനത്തിൽ കേരളത്തിലെ ESA വിസ്തൃതിയുമായി ബന്ധപ്പെട്ട് 9,107 ചതുരശ്ര കിലോമീറ്റർ വനമേഖലയെക്കുറിച്ച് കണക്കുകൾ ഉപയോഗിച്ചിരിക്കുന്നു. ഇത് കേരളത്തിലെ വനംവകുപ്പിന്റെ ഔദ്യോഗിക രേഖ പ്രകാരം കേരളത്തിലെ മുഴുവൻ ഫോറസ്റ്റ് വിസ്തൃതിയാണ്; കേവലം 131 വില്ലേജുകളുടെ മാത്രം ഫോറസ്റ്റ് വിസ്തൃതി ഇതിനേക്കാൾ വളരെ കുറവാണ്.
...
കണക്കുപിശകോ പരിധി-കുഴപ്പമോ കണ്ടെത്തി അത് തിരുത്തിയ ശേഷമേ അന്തിമ വിജ്ഞാപനം പുറപ്പെടുവിക്കാവൂ.$c6m$,
    ...
    'കരട് വിജ്ഞാപനത്തിൽ ഉപയോഗിച്ചിരിക്കുന്ന 131 വില്ലേജുകളിലെ 9,107 ച.കി.മീ. വനവിസ്തൃതിയുടെ പിശക് ഔദ്യോഗിക രേഖകളുമായി പരിശോധിച്ച് തിരുത്തണം',
    $c6e$The draft notification uses a figure of 9,107 square kilometres of forest area in relation to the proposed ESA in Kerala across 131 villages. This figure matches the Forest Department's official record for the entire forest area of the State, not the forest area of the listed villages alone, which is substantially smaller.
...
കണക്കുപിശകോ പരിധി-കുഴപ്പമോ കണ്ടെത്തി അത് തിരുത്തിയ ശേഷമേ അന്തിമ വിജ്ഞാപനം പുറപ്പെടുവിക്കാവൂ.$c6m$
  ...
  (
    ...
    'Letter 7 — Reconsider the proposed 9,993.7 sq. km ESA extent in Kerala',
    'കത്ത് 7 — കേരളത്തിന് നിർദ്ദേശിച്ച ESA വിസ്തൃതി പുനഃപരിശോധിക്കണം',
    ...
    $c7e$The draft notification dated 27 July 2026 proposes an ESA extent of 9,993.7 square kilometres in Kerala. This represents approximately 26 per cent of Kerala's total geographical area. This area must be assessed in the context of Kerala's limited geographical area, high population density and existing forests and protected areas.

The necessity and extent of ESA in Kerala should be reconsidered using Kerala-specific demographic and land-use conditions, limiting ESA to actual forest and protected areas.
...
റവന്യൂ വില്ലേജുകളെ blanket ആയി ESAയിൽ ഉൾപ്പെടുത്താതെ യഥാർത്ഥ വനങ്ങളും സംരക്ഷിത പ്രദേശങ്ങളും കേന്ദ്രീകരിച്ചുള്ള ശാസ്ത്രീയ demarcation നടത്തണമെന്ന് ആവശ്യപ്പെടുന്നു.$c7m$
  ...
  (
    ...
    'Letter 8 — Kerala''s increased population density must be considered in ESA demarcation',
    'കത്ത് 8 — ജനസാന്ദ്രത പ്രത്യേകമായി പരിഗണിക്കണം',
...
ജനസാന്ദ്രത വളരെ ഉയർന്ന വില്ലേജുകളെ ESAയുടെ blanket inclusion-ൽ നിന്ന് ഒഴിവാക്കണമെന്ന് ആവശ്യപ്പെടുന്നു.$c8m$
  ...
  (
    ...
    'Letter 9 — Gram Sabha strongly objects to inclusion of a ward with no forest or protected area',
    'കത്ത് 9 — വനമില്ലാത്ത വാർഡിനെ ഗ്രാമസഭ എതിർക്കുന്നു',
...
അന്തിമ തീരുമാനം എടുക്കുമ്പോൾ ഈ ഗ്രാമസഭ തീരുമാനം ഔദ്യോഗികമായി പരിഗണിക്കണമെന്ന് അഭ്യർത്ഥിക്കുന്നു.$c9m$
  ...
  (
    ...
    'Letter 10 — Where forest land is very limited, only the actual forest land should be included',
    'കത്ത് 10 — വനഭൂമി വളരെ കുറവുള്ള വാർഡിൽ — യഥാർത്ഥ വനഭൂമി മാത്രം ഉൾപ്പെടുത്തണം',
...
Survey Number/Cadastral അതിർത്തി പ്രകാരം വനഭൂമി കൃത്യമായി നിർണയിച്ച് ഔദ്യോഗികമായി സ്ഥിരീകരിച്ച വനഭൂമി മാത്രം ഉൾപ്പെടുത്തണം. ജനവാസ-കൃഷി മേഖലകൾ പൂർണ്ണമായും ഒഴിവാക്കണം.$c10m$
  ...
  (
    v_id, 'WGPPF11', null, 11, true,
    'Letter 11 — Kerala''s increased population density must be specifically considered in ESA demarcation',
    'കത്ത് 11 — ജനസാന്ദ്രത പ്രത്യേകമായി പരിഗണിക്കണം',
    'Population density and land-use intensity have increased; old ESA thresholds should not blanket-include inhabited areas.',
    'പഴയ ESA മാനദണ്ഡങ്ങൾ ഇന്നത്തെ കേരളത്തിന്റെ ജനസാന്ദ്രതയെ പ്രതിഫലിപ്പിക്കുന്നില്ല.',
    $c11e$If it is argued that Kerala's forest extent has increased over the past decades, the equally important fact that population density and intensity of land use have also increased must be considered.

Population-density thresholds used in earlier ESA exercises may not adequately reflect present-day Kerala. Therefore, inclusion of densely inhabited areas based only on older criteria should be reconsidered.

A fresh scientific assessment should use current population data, built-up areas, agricultural land use and public infrastructure.

We request that highly populated areas be excluded from blanket ESA inclusion.$c11e$,
    $c11m$കേരളത്തിലെ വനവിസ്തൃതി വർധിച്ചിട്ടുണ്ടെന്ന വാദം ഉന്നയിക്കപ്പെടുന്നുണ്ടെങ്കിൽ, അതോടൊപ്പം കഴിഞ്ഞ പതിറ്റാണ്ടുകളിൽ ജനസാന്ദ്രതയും ഭൂവിനിയോഗ തീവ്രതയും വർധിച്ചിട്ടുണ്ടെന്ന യാഥാർഥ്യവും പരിഗണിക്കണം.

പഴയ ESA മാനദണ്ഡങ്ങളിൽ ഉപയോഗിച്ച ജനസാന്ദ്രതാ പരിധികൾ ഇന്നത്തെ കേരളത്തിന്റെ യാഥാർഥ്യവുമായി താരതമ്യം ചെയ്യുമ്പോൾ പല പ്രദേശങ്ങളിലും വളരെ താഴ്ന്നതാണ്. അതിനാൽ പഴയ കണക്കുകൾ മാത്രം ഉപയോഗിച്ച് ഇന്നത്തെ ജനവാസ മേഖലകളെ ESAയിൽ ഉൾപ്പെടുത്തുന്നത് പുനഃപരിശോധിക്കണം.

ഇന്നത്തെ ജനസംഖ്യാ കണക്കുകൾ, built-up areas, agricultural land use, public infrastructure എന്നിവ ഉൾപ്പെടുത്തി പുതുക്കിയ scientific assessment നടത്തണം.

ജനസാന്ദ്രത വളരെ ഉയർന്ന വില്ലേജുകളെ ESAയുടെ blanket inclusion-ൽ നിന്ന് ഒഴിവാക്കണമെന്ന് ആവശ്യപ്പെടുന്നു.$c11m$,
    $c11e$If it is argued that Kerala's forest extent has increased over the past decades, the equally important fact that population density and intensity of land use have also increased must be considered.
